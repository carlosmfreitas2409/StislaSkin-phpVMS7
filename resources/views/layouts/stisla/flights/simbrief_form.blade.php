...
@section('content')
    <div class="section-header">
        <h1>@lang('stisla.createbriefing')</h1>
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">@lang('stisla.createbriefing')</div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input id="orig" name="orig" type="text" class="form-control" placeholder="ICAO" maxlength="4" value="{{ $flight->dpt_airport_id }}" />
                            </div>

                            <div class="col-sm-4">
                                <label for="dest">Arrival Airport</label>
                                <input id="dest" name="dest" type="text" class="form-control" placeholder="" maxlength="4" value="{{ $flight->arr_airport_id }}" />
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td><input type="hidden" name="navlog" value="0"><input type="checkbox" name="navlog" value="1" checked>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="hidden" name="stepclimbs" value="0"><input type="checkbox" name="stepclimbs" value="1" checked>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="hidden" name="notams" value="0"><input type="checkbox" name="notams" value="1" checked>
                                </td>
                            </tr>
                            <tr>
                                <td>FIR NOTAMS:</td>
                        ...
                        <input type="button" onclick="simbriefsubmit('{{ $flight->id }}', '{{ url(route('frontend.simbrief.briefing', [''])) }}');" class="btn btn-primary float-right" value="Generate">
                    </div>
                </div>
            </div>
        </div>
